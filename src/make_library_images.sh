...
declare -a platforms=("a26" "a52" "arduboy" "coleco" "gb" "gba" "gbc" "genesis" "gg" "intv" "msx" "nes" "ng" "ngp" "ngpc" "pce" "poke_mini" "scd" "sdvmu" "sg1000" "sms" "snes" "supervision" "vb" "vectrex" "wsc")
